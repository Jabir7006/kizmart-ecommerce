...
export const OrderSummary = ({ paymentMethod, subtotal, shipping, taxes, total }: OrderSummaryProps) => {
  return (
    <div className="sticky top-24 space-y-6">
      <section className="animate-in slide-in-from-right-8 duration-500 fade-in fill-mode-both" style={{ animationDelay: '400ms' }}>
        <Card className="rounded-2xl shadow-sm border-neutral-200 dark:border-neutral-800 overflow-hidden">
          ...
          <CardContent className="pt-6">
            <div className="max-h-[300px] overflow-y-auto pr-2 space-y-4 scrollbar-thin scrollbar-thumb-neutral-200 dark:scrollbar-thumb-neutral-800">
              {MOCK_CART.map((item) => (
                <div key={item.id} className="flex gap-4 p-2 rounded-lg hover:bg-neutral-50 dark:hover:bg-neutral-900/50 transition-colors">
                  <div className="relative h-16 w-16 rounded-md overflow-hidden flex-shrink-0 border border-neutral-200 dark:border-neutral-800">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="secondary" className="h-10 px-4 shrink-0">Apply</Button>
              </div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex justify-between text-neutral-500">
                  ...
                  <span className="font-medium text-neutral-900 dark:text-neutral-100">${taxes.toFixed(2)}</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-end">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-neutral-500">Including $1.50 in taxes</span>
                </div>
          ...
          <CardFooter className="flex-col gap-4 bg-neutral-50/50 dark:bg-neutral-900/20 pt-6">
            <Button size="lg" className="w-full text-base font-medium h-12 shadow-lg shadow-primary/20 hover:shadow-primary/40 transition-shadow">
              {paymentMethod === 'paypal' ? 'Proceed with PayPal' : 'Pay now'}
            </Button>
      ...
      <section className="grid grid-cols-2 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 fill-mode-both" style={{ animationDelay: '500ms' }}>
